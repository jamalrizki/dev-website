		...
		<div class="row">
			<div class="col-12 mb-4 mb-md-0 justify-content-center">
				...
				<div class="rounded-social-buttons tag">
					<a class="social-button linkedin" href="https://www.linkedin.com/in/jamal-rizki-66598777" target="_blank" rel="noopener noreferrer">
						<!-- svg code for linkedin icon -->
						<svg class="linkedin-icon-footer feather feather-linkedin" xmlns="http://www.w3.org/2000/svg" width="35" viewBox="0 0 24 24" fill="#0e76a8" stroke-width="1" stroke-linecap="round" stroke-linejoin="round">
							<path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"></path>
							<rect x="2" y="9" width="4" height="12"></rect>
							<circle cx="4" cy="4" r="2"></circle>
						</svg>
					</a>
					<a class="social-button instagram" href="https://www.instagram.com/jamalbrizki/" target="_blank" rel="noopener noreferrer">
					...
					<a class="social-button github" href="https://github.com/jamalrizki" target="_blank" rel="noopener noreferrer">
