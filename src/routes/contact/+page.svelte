<script>
	...
	import { paths } from '$lib/data/contactPaths.js';

	// SVG morph animation ported from assets/js/contact.js (anime.js v2 -> v3 API)
	onMount(async () => {
		...
		paths.forEach((path, index) => {
			timeline.add(
				{
					targets: path.id,
					d: { value: path.d, duration: 1000, easing: 'easeInOutQuad' }
				},
				1000 + 10 * index
			);
		});
		...
		timeline.add(
			{
				targets: '.contact-svg path:first-child',
...
<svelte:head>
	<title>Jamal Rizki | Contact</title>
	...
	<link rel="canonical" href="https://www.jrizki.com/contact" />
	<meta property="og:title" content="Jamal Rizki | Contact" />
</svelte:head>

<div class="contact-wrap">
	<div class="contact-grid">
		<!-- Left: intro + direct contact + signature accent -->
		<div class="contact-left">
			...
			<a class="contact-row" href="mailto:hello@jrizki.com">
				<span class="contact-icon" aria-hidden="true">
					<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="4" width="20" height="16" rx="2"/><path d="m22 7-10 5L2 7"/></svg>
				</span>
				<span>jamal@jamalrizki.com</span>
			</a>

			<a class="contact-row" href="https://www.linkedin.com/in/jamal-rizki-66598777" target="_blank" rel="noopener noreferrer">
				<span class="contact-icon" aria-hidden="true">
				...
				<span>linkedin.com/in/jamal-rizki</span>
			</a>

			<div class="contact-svg signature" aria-hidden="true">
				<svg xmlns="http://www.w3.org/2000/svg" width="150" height="150" viewBox="0 0 700 600">
		...
		<div class="contact-form-card">
			<form action="https://formspree.io/f/mzbolpvr" method="POST">
...
<style>
	...
	.contact-form-card textarea:focus {
		border-color: #29c7d9;
		box-shadow: 0 0 0 3px rgba(41, 199, 217, 0.15);
	}
	.contact-form-card textarea {
		resize: vertical;
	}
